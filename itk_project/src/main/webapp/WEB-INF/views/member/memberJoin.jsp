				...
				<div class="col-12">
					<div class="block">
						...
						<div class="image align-self-center">
							<img class="img-fluid" src="images/Login/sign-up.jpg"
								alt="desk-image">
						</div>
						<!-- Content -->
						<div class="content text-center">
							<div class="logo">
								<a href="index.html"><img id="signUp_logo"
							...
							<form action="#">
								<!-- Username -->
								<input class="form-control main" type="text" name="member_id"
									id="member_id" placeholder="아이디">
								<!-- Email -->
								<input class="form-control main" type="text" name="member_name"
									id="member_name" placeholder="이름"> <input
									class="form-control main" type="text" name="member_nickname"
									id="member_nickname" placeholder="닉네임">
								<!-- Password -->
								<input class="form-control main" type="password"
									placeholder="비밀번호" id="member_pw1"> <input
									class="form-control main" type="password" name="member_pw"
									id="member_pw2" placeholder="비밀번호 확인">
								<!-- Submit Button -->
								<button class="btn btn-main-md" onclick="doJoin()" type="button">회원가입</button>
							</form>
							<div class="new-acount">
								<p>
									이미 계정이 존재합니까?<a href="signin">로그인</a>
								</p>
							</div>
						</div>
					</div>
