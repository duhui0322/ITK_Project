...
<body class="body-wrapper" data-spy="scroll" data-target=".privacy-nav">
	...
	<section>
		...
		<form action="event_write" name="event_write" method="post">
			<table id=write_table>
				...
				<tr class = "tr_board_write">
					<th>이벤트기간</th>
					<td class = "td_write_board_date"><input type="date" name="event_start_day" class = "event_date" ><span id = "dash_color">-</span>
					<input type="date" name="event_finish_day" class = "event_date" ></td>
